import torch
import copy
from .kan_utils.layers import RBFKANLayer, SplinesKANLayer
from .kan_utils.polynomial_layers import ChebyshevKANLayer
from .kan_utils.permutations import invariant_input
...
class KAN(NN):
    ...
    def forward(self, x: torch.Tensor, step=0, update_grid=False):
        for layer in self.layers:
            '''if update_grid or step % 100 == 0:
